...
1. Find an [issue](https://github.com/Astridisweird/remastered-overwatch-2/pulls) to fix (or submit one yourself).
...
7. Submit [Merge Request](https://github.com/Astridisweird/remastered-overwatch-2/compare) (MR) to merge your branch into staging branch.
